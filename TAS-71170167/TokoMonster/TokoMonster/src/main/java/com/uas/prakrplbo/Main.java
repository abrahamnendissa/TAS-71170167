    ...
    public static void main(String[] args) {
        ...
        while(pilihan != 5) {
            ...
            switch (pilihan) {
                ...
                break; case 3: tampilkanMonsterSaya();
                System.out.println("Monster nomor berapa yang akan kamu lihat?");
                System.out.print("Nomor monster: ");
                int monster = input.nextInt();
                getMonsterSaya(monster).getInfo();
                break;
                case 4: tampilkanMonsterSaya();
                break;
                default: System.out.println("Terima kasih, " + nama + ", semoga harimu menyenangkan!");
                break;
            }
            System.out.println("\n===========================\n");
        }
